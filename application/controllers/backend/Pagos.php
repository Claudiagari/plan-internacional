...
class Pagos extends MY_Controller {
	...
	function __construct() {
		...
		$config['table'] = 'pagos';
		$config['title'] = array('espanol' => 'Registro de Pagos');
		$config['type'] = 'table';
		$config['export'] = TRUE;
		...
		$items['tipo_pago'] = array('type' => 'select', 'text' => array('espanol' => 'Tipo de Donación'), 'readonly' => TRUE, 'table' => TRUE, 'items' => array('', 'PAGO UNICO', 'PAGO MENSUAL'));
