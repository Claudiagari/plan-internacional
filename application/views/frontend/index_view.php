                ...
                <div class="col-xs-12 col-sm-12 col-md-12 cont-rsp-padd">
                    <div class="col-xs-12 col-sm-12 col-md-10 ctn-formulario">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#unete"
                                                  class="unete"><?php echo $campania['unete']; ?></a></li>
                            <li><a data-toggle="tab"
                                   onclick="javascript:configurar_descripcion('<?php echo $campania['primer_tipo_donacion']; ?>');"
                                   href="#section_precios_tipo_uno"
                                   class="dona-btn"><?php echo $campania['primer_tipo_donacion']; ?></a></li>
                            <li><a data-toggle="tab"
                                   onclick="javascript:configurar_descripcion('<?php echo $campania['segundo_tipo_donacion']; ?>');"
                                   href="#section_precios_tipo_dos"
                                   class="dona-btn"><?php echo $campania['segundo_tipo_donacion']; ?></a></li>
                        </ul>
                        ...
                        <div class="tab-content bg-formulario">
                                ...
                                <form method="POST" action="<?php echo base_url(); ?>unete">
                                    <div class="personal-info col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
                                                ...
                                                <input type="text"
                                                       class="form-control validate[required, custom[onlyLetterSp]]"
                                                       placeholder="Apellido Paterno" id="apellido-parterno"
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
                                                ...
                                                <input type="text"
                                                       class="form-control validate[required, custom[onlyLetterSp]]"
                                                       placeholder="Apellido Materno" id="apellido-materno"
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
                                                <input type="number" min="1111111"
                                                       ...
                                                       placeholder="Celular" id="celular" name="celular"/>
                                            </div>
                                            <hr class="hr-1">
                                            <div class="block">
                                            </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 ctn-doc">
                                            ...
                                            <div class="col-xs-8 col-sm-8 col-md-8 reset-total">
                                                <div class="col-xs-4 col-sm-4 col-md-4 reset-total">
                                                    <label class="container-check">
                                                        DNI
                                                        <input type="radio" class="validate[required]" id="dni"
                                                               value="1" name="tipo_documento"
                                                               onclick="javascript:validar_documento(this);"/>
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4 reset-total">
                                                    <label class="container-check">
                                                        CE
                                                        <input type="radio" class="validate[required]" id="ce" value="2"
                                                               name="tipo_documento"
                                                               onclick="javascript:validar_documento(this);">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4 reset-total">
                                                    <label class="container-check">
                                                        Otro
                                                        <input type="radio" class="validate[required]" id="otro"
                                                               value="3" name="tipo_documento"
                                                               onclick="javascript:validar_documento(this);">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 reset-total otro hidden">
                                            <div class="form-group">
                                                <input type="text" id="otro_tipo_documento" class="form-control"
                                                       name="otro_tipo_documento"
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 form-group cont-camp reset-total">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-8 term-cond">
                                            <label class="container-check">
                                                Acepto los
                                                <input type="checkbox" class="validate[required]" name="terminos"
                                                       value="1" id="terminos"/>
                                                <span class="checkmark"></span>
                                            </label>
                                            <a href="<?php echo base_url(); ?>uploads/TérminosyCondiciones_Plan.pdf"
                            ...
                            <?php $tipos = array(1 => 'precios_tipo_uno', 2 => 'precios_tipo_dos');
                            $descripciones = array(1 => 'primer_tipo_donacion', 2 => 'segundo_tipo_donacion'); ?>

                            <?php foreach ($tipos as $key => $value): ?>
                                <pre><?php var_dump($value) ?></pre>
                                <div id="section_<?php echo $value; ?>" class="tab-pane fade">
                                    <form method="POST" action="<?php echo base_url(); ?>checkout">
                                        <input type="hidden" name="tipo_pago" id="tipo_pago_<?php echo $key; ?>"
                                               value="<?php echo $key; ?>"/>
                                        <input type="hidden" name="descripcion" id="descripcion_<?php echo $key; ?>"
                                               value="<?php echo $descripciones[$key]; ?>"/>
                                        <input type="hidden" name="cantidad_apoyo"
                                               id="cantidad_apoyo_<?php echo $key; ?>"/>
                                        ...
                                        <div class="col-md-4 ctn-doc">
                                            <div class="col-xs-12 col-sm-12 col-md-12 reset-total">
                                                <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <label class="container-check">
                                                        Soles
                                                        <input type="radio" name="tipo_moneda"
                                                               id="soles_<?php echo $key; ?>"
                                                               onclick="javascript:configurar_moneda('PEN');"
                                                               value="PEN" checked="checked"/>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <label class="container-check">
                                                        Dólares
                                                        <input type="radio" name="tipo_moneda"
                                                               id="dolares_<?php echo $key; ?>"
                                                               onclick="javascript:configurar_moneda('USD');"
                                                               value="USD"/>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 reset-total">
                                                <div class="cont-select">
                                                    <select name="monto_total" class="validate[required]"
                                                            onchange="javascript:validar_otro_monto(this, <?php echo $key; ?>);"
                                                            id="monto_total_<?php echo $key; ?>">
                                                        <option value="" disabled="disabled" selected="selected">
                                                            Selecciona un monto
                                                        </option>
                                                        <?php foreach ($$value as $k => $v): ?>
                                                            <option data-apoyo="<?php echo $v['cantidad_apoyo']; ?>"
                                                                    value="<?php echo $v['precio']; ?>"
                                                                    class="color-2"><?php echo $v['precio']; ?></option>
                                                        <?php endforeach; ?>
                                                        <option value="1" data-apoyo="0" class="color-2">Otro Monto
                                                        </option>
                                                    </select>
                                                </div>
                                                    ...
                                                    <div class="col-md-12 ctn-doc reset-total">
                                                        ...
                                                        <div class="form-group camp-obli">
                                                            ...
                                                            <?php if ($campania['monto_minimo'] > 0): ?>
                                                                <p>Monto
                                                                    mínimo <?php echo $campania['monto_minimo']; ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-4 personal-info">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
                                                ...
                                                <input type="text"
                                                       class="form-control validate[required, custom[onlyLetterSp]]"
                                                       placeholder="Nombres" id="nombres_<?php echo $key; ?>"
                                                       name="nombres"/>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
                                                <label>*</label>
                                                <input type="text"
                                                       ...
                                                       id="apellido_paterno_<?php echo $key; ?>"
                                                       name="apellido_paterno"/>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
                                                <label>*</label>
                                                <input type="text"
                                                       ...
                                                       id="apellido_materno_<?php echo $key; ?>"
                                                       name="apellido_materno"/>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
                                                <label>*</label>
                                                <input type="text"
                                                       class="form-control validate[required, custom[email]]"
                                                       placeholder="Email" id="email_<?php echo $key; ?>" name="email"/>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
                                                <input type="text"
                                                       class="form-control validate[required, custom[phone]]"
                                                       placeholder="Celular" id="celular_<?php echo $key; ?>"
                                                       name="celular"/>
                                            </div>
                                            <hr class="hr-1">
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-4 ctn-doc">
                                                ...
                                                <div class="col-xs-8 col-sm-8 col-md-8 reset-total">
                                                    <div class="col-xs-4 col-sm-4 col-md-4 reset-total">
                                                        <label class="container-check">
                                                            ...
                                                            <input type="radio" class="validate[required]"
                                                                   onclick="javascript:validar_documento(this, '<?php echo $key; ?>');"
                                                                   name="tipo_documento" id="dni_<?php echo $key; ?>"
                                                                   value="1"/>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-xs-4 col-sm-4 col-md-4 reset-total">
                                                        <label class="container-check">
                                                            ...
                                                            <input type="radio" class="validate[required]"
                                                                   onclick="javascript:validar_documento(this, '<?php echo $key; ?>');"
                                                                   name="tipo_documento" id="ce_<?php echo $key; ?>"
                                                                   value="2"/>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-xs-4 col-sm-4 col-md-4 reset-total">
                                                        <label class="container-check">
                                                            ...
                                                            <input type="radio" class="validate[required]"
                                                                   onclick="javascript:validar_documento(this, '<?php echo $key; ?>');"
                                                                   name="tipo_documento" id="otro_<?php echo $key; ?>"
                                                                   value="3"/>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 reset-total otro hidden">
                                                <div class="form-group">
                                                    <input type="text" id="otro_tipo_documento_<?php echo $key; ?>"
                                                           class="form-control" name="otro_tipo_documento"
                                                           placeholder="Especifique el tipo de documento"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 reset-total">
                                                <div class="form-group">
                                                    <input type="text"
                                                           ...
                                                           id="numero_documento_<?php echo $key; ?>"
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 form-group cont-camp reset-total">
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-4 camp-obli">
                                                <button type="button" onclick="javascript:pagar(this);"
                                                        class="btn-primary">Donar
                                                </button>
                                                <p>*Campos obligatorios</p>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-8 term-cond">
