						...
						<div class="tab-content bg-formulario">
							...
							<form method="POST" action="<?php echo base_url(); ?>checkout">
									...
									<div class="col-md-4 personal-info">
						                ...
						                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
						                	<label>*</label>
						                    <input type="text" class="form-control validate[required, custom[onlyLetterSp]]" placeholder="Apellido Materno" id="apellido_materno_<?php echo $key; ?>" name="apellido_materno" />
						                </div>
						                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
						                	<label>*</label>
					                ...
					                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 form-group cont-camp reset-total">
					                    ...
					                    <div class="col-xs-6 col-sm-6 col-md-8 term-cond">
											...
											<a href="#" data-toggle="modal" data-target="#myModalLogin">Términos y Condiciones</a>
							            </div>
					                </div>
			            		</form>
							</div>
